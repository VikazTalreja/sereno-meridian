...
authors:
  - waleed
readingTime: 8
tags: [Release, Copilot, MCP, Observability, Collaboration, Integrations]
ogImage: /studio/v0-5/cover.png
ogAlt: 'v0.5 release announcement'
about: ['AI Agents', 'Workflow Automation', 'Developer Tools']
timeRequired: PT8M
canonical: /studio/v0-5
featured: true
draft: false
---

**v0.5** is the next evolution of our agent workflow platform—built for teams shipping AI agents to production.

## Copilot

![Copilot](/studio/v0-5/copilot.jpg)

Copilot is a context-aware assistant embedded in the editor. Unlike general-purpose AI assistants, Copilot has direct access to your workspace: workflows, block configurations, execution logs, connected credentials, and documentation. It can also search the web to pull in external context when needed.
...
**Webhooks**: The platform provisions a unique HTTPS endpoint for each workflow. Incoming POST requests are parsed and passed to the first block as input. Supports standard webhook patterns including signature verification for services that provide it.
...
Upload documents—PDFs, text files, markdown, HTML—and make them queryable by your agents. This is [RAG](https://en.wikipedia.org/wiki/Retrieval-augmented_generation) (Retrieval Augmented Generation) built directly into the platform.
...
- **Workflows as tools**: Agents can invoke other workflows, enabling hierarchical architectures where a coordinator agent delegates to specialized sub-workflows
...
The platform supports 14 providers: [OpenAI](https://openai.com), [Anthropic](https://anthropic.com), [Google](https://ai.google.dev), [Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-services/openai-service), [xAI](https://x.ai), [Mistral](https://mistral.ai), [Deepseek](https://deepseek.com), [Groq](https://groq.com), [Cerebras](https://cerebras.ai), [Ollama](https://ollama.com), and [OpenRouter](https://openrouter.ai).
...
These features are available now. Check out the documentation to dive deeper.
