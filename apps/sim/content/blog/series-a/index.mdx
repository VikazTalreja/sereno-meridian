...
slug: series-a
title: '$7M Series A'
description: We’re excited to share that we have raised a $7M Series A led by Standard Capital to accelerate our vision for agentic workflows.
date: 2025-11-12
updated: 2025-11-12
authors:
  - waleed
  - emir
readingTime: 4
tags: [Announcement, Funding, Series A, YCombinator]
ogImage: /studio/series-a/cover.png
ogAlt: 'Team photo in front of neon logo'
about: ['Artificial Intelligence', 'Agentic Workflows', 'Startups', 'Funding']
timeRequired: PT4M
canonical: /studio/series-a
featured: true
draft: false
---

![Team photo](/studio/series-a/team.jpg)
...
Soon after, we'd built the foundation of what would become our current platform.
We were hellbent on being Open Source from day one, and we're proud that we've stuck to that commitment. 

## Progress so far

In just a short few months, the platform has grown from 0->18k Github stars, 60,000+ developers on the platform, and 100+ companies ranging from startups to large enterprises using it in production.
...
Our platform is both easy to use and powerful enough to build complex agentic workflows.

If you strip away the applications, workflows are all that's left. They're the foundation of the software industry, and they're the foundation of the future powered by this approach.

## What’s next

We’ll invest in building the community around the platform, and we'll continue to be relentlessly focused on building the best foundation for agentic workflows.
